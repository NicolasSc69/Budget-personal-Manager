...
final class Version20260821140000 extends AbstractMigration
{
    ...
    {
        return 'Add recurrence_end_date column to transactions';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE transactions ADD COLUMN recurrence_end_date DATE DEFAULT NULL');
    }

    public function down(Schema $schema): void
    {
        $this->addSql('CREATE TEMPORARY TABLE __temp__transactions AS SELECT id, title, amount, date, recurrence, is_cheque, cheque_number, category_id, account_id, recurrence_parent_id, destination_account_id FROM transactions');
        ...
        $this->addSql('INSERT INTO transactions (id, title, amount, date, recurrence, is_cheque, cheque_number, category_id, account_id, recurrence_parent_id, destination_account_id) SELECT id, title, amount, date, recurrence, is_cheque, cheque_number, category_id, account_id, recurrence_parent_id, destination_account_id FROM __temp__transactions');
