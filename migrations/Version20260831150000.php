...
final class Version20260831150000 extends AbstractMigration
{
    ...
    {
        return 'Add locale column to app_setting';
    }
    ...
    {
        $this->addSql('CREATE TEMPORARY TABLE __temp__app_setting AS SELECT id, items_per_page, backup_directory FROM app_setting');
        ...
        $this->addSql('INSERT INTO app_setting (id, items_per_page, backup_directory) SELECT id, items_per_page, backup_directory FROM __temp__app_setting');
